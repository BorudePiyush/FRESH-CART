let elementsel = document.querySelector(".elements");
 ...
 let cartitemsel = document.querySelector(".cartbody");

 let subtotal =document.querySelector(".subtotal");
 let itemincrment =document.querySelector(".btn-light span");
...
function displayproducts()
{
   ...
   <div class="card-body">
     ...
     <img src="images/images/${product.id}.jpg" class="ms-5" height="140" width="140">
...
console.log("ggg")
           ...
           {
                 changeqty("pluse" ,id)
                 console.log("same product is olready tehre")

           }else{

               console.log("ready to add teh data")
       ...
       cartitemsel.innerHTML ="";
         ...
         cart.forEach((item)=>{
                  ...
                  <tbody>
                    <tr>
                    <td>
                       <img src="/images/images/${item.id}.jpg" height=50 width=50>
                    </td>
                    <td>
...
function changeqty(action, id) {
    cart = cart.map((item) => {
        ...
        console.log(item.name + "kkkkkk" + qty)
        return {
...
function rendersubtotal()
{
     ...
     let totalitems=0;
         ...
         itemincrment.innerHTML=totalitems;
